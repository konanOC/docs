...
- [小出 先生（知能情報学部. 以降 敬称略）](https://researchers.adm.konan-u.ac.jp/html/528_ja.html)
- [木村（知能情報学部 4年）](https://yuto-kimura-g.github.io/)
...
まずは，アプリを作るための技術を思いつく限りリストアップします．
...
HTML, CSS, JSのマナーや，GitHubの使い方などを伝えました．

このプロジェクトは [GitHub Flow](https://docs.github.com/ja/get-started/quickstart/github-flow) という方針で開発するため，Gitコマンドの簡易マニュアルを書いたりもしました．
...
エンディング画面の実装には，せっかくなのでオープンキャンパススタッフの角谷さんに担当してもらいました．本人曰くプログラミングが苦手らしいですが，いい経験になったんじゃないでしょうか．オブジェクト指向プログラミングﾁｮｯﾄﾃﾞｷﾙになっていたら嬉しいです．
...
## 5. やり残したこと
もう少し時間があればやりたかったことは沢山ありますが，まあ最低限必要なものは完成出来たので良しとします．

### 5.1. モダンな技術の使用
- TypeScript：JavaScriptはクソ
- React
- RustでWASM：個人的にRustを勉強してるので，使ってみたい

### 5.2. デザインツール
- Figmaでデザインしてみたかった

### 5.3. docker
- 完成したdockerコンテナを配布すれば，メンバーが環境構築で躓く心配がない
...
このページを読んで面白そうだと感じた人は，知能情報学部に進んでみてはいかがでしょうか．きっと楽しい日々を過ごせます．
